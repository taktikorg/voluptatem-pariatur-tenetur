...
1. Supported Node.js versions vary by release, please consult the [releases page](https://github.com/taktikorg/voluptatem-pariatur-tenetur/releases).
1. Node versions that hit end of life <https://github.com/nodejs/Release>, will be dropped from support at each @taktikorg/voluptatem-pariatur-tenetur release (major, minor).
...
Below is a quick guide for minimum and maximum supported versions of @taktikorg/voluptatem-pariatur-tenetur:

NodeJS  | Supported @taktikorg/voluptatem-pariatur-tenetur version | Node Module
--------|-----------------------------|------------
Node 20 | 9.0+                        | 115
Node 19 | 8.0+                        | 111
Node 18 | 8.0+                        | 108
...
<table>
  <tr>
    <td>
      <img width="77px" alt="Sass logo" src="https://rawgit.com/sass/@taktikorg/voluptatem-pariatur-tenetur/master/media/logo.svg" />
    </td>
    <td valign="bottom" align="right">
      <a href="https://www.npmjs.com/package/@taktikorg/voluptatem-pariatur-tenetur">
        <img width="100%" src="https://nodei.co/npm/@taktikorg/voluptatem-pariatur-tenetur.png?downloads=true&downloadRank=true&stars=true">
      </a>
    </td>
  </tr>
</table>

![Alpine](https://github.com/taktikorg/voluptatem-pariatur-tenetur/workflows/Build%20bindings%20for%20Alpine%20releases/badge.svg)
![Linux](https://github.com/taktikorg/voluptatem-pariatur-tenetur/workflows/Build%20bindings%20for%20Linux%20releases/badge.svg)
![macOS](https://github.com/taktikorg/voluptatem-pariatur-tenetur/workflows/Build%20bindings%20for%20macOS%20releases/badge.svg)
![Windows x64](https://github.com/taktikorg/voluptatem-pariatur-tenetur/workflows/Build%20bindings%20for%20Windows%20releases/badge.svg)
![Linting](https://github.com/taktikorg/voluptatem-pariatur-tenetur/workflows/Lint%20JS/badge.svg)
[![Windows x86](https://ci.appveyor.com/api/projects/status/22mjbk59kvd55m9y/branch/master?svg=true)](https://ci.appveyor.com/project/sass/@taktikorg/voluptatem-pariatur-tenetur/branch/master)
[![Coverage Status](https://coveralls.io/repos/sass/@taktikorg/voluptatem-pariatur-tenetur/badge.svg?branch=master)](https://coveralls.io/r/sass/@taktikorg/voluptatem-pariatur-tenetur?branch=master)

Node-sass is a library that provides binding for Node.js to [LibSass], the C version of the popular stylesheet preprocessor, Sass.

It allows you to natively compile .scss files to css at incredible speed and automatically via a connect middleware.

Find it on npm: <https://www.npmjs.com/package/@taktikorg/voluptatem-pariatur-tenetur>
...
```shell
npm install @taktikorg/voluptatem-pariatur-tenetur
```
...
Are you seeing the following error? Check out our [Troubleshooting guide](https://github.com/taktikorg/voluptatem-pariatur-tenetur/blob/master/TROUBLESHOOTING.md#installing-@taktikorg/voluptatem-pariatur-tenetur-4x-with-node--4).**

```
SyntaxError: Use of const in strict mode.
```

**Having installation troubles? Check out our [Troubleshooting guide](https://github.com/taktikorg/voluptatem-pariatur-tenetur/blob/master/TROUBLESHOOTING.md).**
...
```javascript
var sass = require('@taktikorg/voluptatem-pariatur-tenetur');
sass.render({
  file: scss_filename,
  [, options..]
}, function(err, result) { /*...*/ });
...
```javascript
var Color = require('@taktikorg/voluptatem-pariatur-tenetur').types.Color,
...
__Note:__ @taktikorg/voluptatem-pariatur-tenetur/libsass will compile a mixed library of scss and indented syntax (.sass) files with the Default setting (false) as long as .sass and .scss extensions are used in filenames.
...
* In the case that both `file` and `data` options are set, @taktikorg/voluptatem-pariatur-tenetur will give precedence to `data` and use `file` to calculate paths in sourcemaps.

### Version information (>= v2.0.0)

Both `@taktikorg/voluptatem-pariatur-tenetur` and `libsass` version info is now exposed via the `info` method:
...
/*
  ...
  @taktikorg/voluptatem-pariatur-tenetur       2.0.1   (Wrapper)       [JavaScript]
  libsass         3.1.0   (Sass Compiler) [C/C++]
*/
```

Since @taktikorg/voluptatem-pariatur-tenetur >=v3.0.0 LibSass version is determined at run time.

## Integrations

Listing of community uses of @taktikorg/voluptatem-pariatur-tenetur in build tools and frameworks.

### Brackets extension

[@jasonsanjose](https://github.com/jasonsanjose) has created a [Brackets](http://brackets.io) extension based on @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/jasonsanjose/brackets-sass>. When editing Sass files, the extension compiles changes on save. The extension also integrates with Live Preview to show Sass changes in the browser without saving or compiling.

### Brunch plugin

[Brunch](http://brunch.io)'s official sass plugin uses @taktikorg/voluptatem-pariatur-tenetur by default, and automatically falls back to ruby if use of Compass is detected: <https://github.com/brunch/sass-brunch>

### Connect/Express middleware

Recompile `.scss` files automatically for connect and express based http servers.

This functionality has been moved to [`@taktikorg/voluptatem-pariatur-tenetur-middleware`](https://github.com/taktikorg/voluptatem-pariatur-tenetur-middleware) in @taktikorg/voluptatem-pariatur-tenetur v1.0.0

### DocPad Plugin

[@10xLaCroixDrinker](https://github.com/10xLaCroixDrinker) wrote a [DocPad](http://docpad.org/) plugin that compiles `.scss` files using @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/docpad/docpad-plugin-nodesass>

### Duo.js extension

[@stephenway](https://github.com/stephenway) has created an extension that transpiles Sass to CSS using @taktikorg/voluptatem-pariatur-tenetur with [duo.js](http://duojs.org/)
<https://github.com/duojs/sass>

### Grunt extension

[@sindresorhus](https://github.com/sindresorhus/) has created a set of grunt tasks based on @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/sindresorhus/grunt-sass>

### Gulp extension

[@dlmanning](https://github.com/dlmanning/) has created a gulp sass plugin based on @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/dlmanning/gulp-sass>

### Harp

[@sintaxi](https://github.com/sintaxi)’s Harp web server implicitly compiles `.scss` files using @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/sintaxi/harp>

### Metalsmith plugin

[@stevenschobert](https://github.com/stevenschobert/) has created a metalsmith plugin based on @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/stevenschobert/metalsmith-sass>

### Meteor plugin

[@fourseven](https://github.com/fourseven) has created a meteor plugin based on @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/fourseven/meteor-scss>

### Mimosa module

[@dbashford](https://github.com/dbashford) has created a Mimosa module for sass which includes @taktikorg/voluptatem-pariatur-tenetur: <https://github.com/dbashford/mimosa-sass>

## Example App

There is also an example connect app here: <https://github.com/andrew/@taktikorg/voluptatem-pariatur-tenetur-example>
...
```bash
git clone --recursive https://github.com/taktikorg/voluptatem-pariatur-tenetur.git
cd @taktikorg/voluptatem-pariatur-tenetur
npm install
...
### Usage
 ...
 `@taktikorg/voluptatem-pariatur-tenetur [options] <input> [output]`
 Or:
 `cat <input> | @taktikorg/voluptatem-pariatur-tenetur > output`

Example:

`@taktikorg/voluptatem-pariatur-tenetur src/style.scss dest/style.css`
...
Also, note `--importer` takes the (absolute or relative to pwd) path to a js file, which needs to have a default `module.exports` set to the importer function. See our test [fixtures](https://github.com/taktikorg/voluptatem-pariatur-tenetur/tree/974f93e76ddd08ea850e3e663cfe64bb6a059dd3/test/fixtures/extras) for example.
...
@taktikorg/voluptatem-pariatur-tenetur supports different configuration parameters to change settings related to the sass binary such as binary name, binary path or alternative download path. Following parameters are supported by @taktikorg/voluptatem-pariatur-tenetur:
...
* E.g. `npm install @taktikorg/voluptatem-pariatur-tenetur --sass-binary-site=http://example.com/`
...
We <3 our contributors! A special thanks to all those who have clocked in some dev time on this project, we really appreciate your hard work. You can find [a full list of those people here.](https://github.com/taktikorg/voluptatem-pariatur-tenetur/graphs/contributors)
...
Copyright (c) 2015 Andrew Nesbitt. See [LICENSE](https://github.com/taktikorg/voluptatem-pariatur-tenetur/blob/master/LICENSE) for details.
